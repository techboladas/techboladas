...
export const Contact = () => {
  return (
     <section id="contact" className="h-screen w-10/12 p-10 ml-20 flex flex-col justify-start bg-pallete-t30 rounded">
        ...
        <article className="">
          ...
          <LinkBlock Icon={MdAlternateEmail} href="techboladas@gmail.com">Email</LinkBlock>
